    ...
    if file_type == '1':
        ...
        try:
            with open(name, 'r') as user_selected_file:
                for line in user_selected_file:
...
def prompt():
    print('Type in 1 to send a text file or type in 2 to send an image file. Or type in 3 to retrieve a file that you have saved. Type in 4  \n')
    type_of_file = input()
    if type_of_file == '1':            
        directory = input('Enter directory where file is stored')
        file_name = input('Enter file name')
